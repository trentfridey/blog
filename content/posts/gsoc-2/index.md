...
Picking up from last [week](https://blog.trentfridey.com/gsoc-1), this week I focused on establishing a build environment for the QuTiP Virtual Lab application.
...
## Running the Application in a React App {#running-the-application-in-a-react-app}
